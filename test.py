...
if __name__ == '__main__':
    ...
    model = QCLNet(args.backbone, args.use_original_imgsize)
    model.eval()
    ...
    FSSDataset.initialize(benchmark=args.benchmark, img_size=473, datapath=args.datapath, use_original_imgsize=args.use_original_imgsize)
